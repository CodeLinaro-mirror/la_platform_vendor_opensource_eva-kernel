...
#define  HFI_CMD_SESSION_EVA_LSR_SET_GAINMAP_GAMMA\
...
#if IS_REACHABLE(CONFIG_QCOM_KGSL)
#define  HFI_CMD_SESSION_EVA_LSR_GMU_START\
         (HFI_CMD_SESSION_CVP_START + 0x083)
#define  HFI_CMD_SESSION_EVA_LSR_GMU_STOP\
         (HFI_CMD_SESSION_CVP_START + 0x084)
#endif
...
#define  HFI_MSG_SESSION_EVA_LSR_SET_GAINMAP_GAMMA\
...
#define  HFI_CMD_SESSON_EVA_LSR_GCX_CONFIG_PARAMS\
    (HFI_CMD_SESSION_CVP_START +  0x088)
#define  HFI_MSG_SESSON_EVA_LSR_GCX_CONFIG_PARAMS\
    (HFI_MSG_SESSION_CVP_START + 0x58)
...
#if IS_REACHABLE(CONFIG_QCOM_KGSL)
#define  HFI_MSG_SESSION_EVA_LSR_GMU_START\
         (HFI_MSG_SESSION_CVP_START + 0x54)
#define  HFI_MSG_SESSION_EVA_LSR_GMU_STOP\
         (HFI_MSG_SESSION_CVP_START + 0x55)
#endif
...
static inline enum buf_map_type cvp_find_map_type(int pkt_type)
{
	if (pkt_type == HFI_CMD_SESSION_CVP_SET_PERSIST_BUFFERS ||
			...
			pkt_type == HFI_CMD_SESSION_EVA_LSR_SET_GAINMAP_GAMMA)
		return MAP_PERSIST;
